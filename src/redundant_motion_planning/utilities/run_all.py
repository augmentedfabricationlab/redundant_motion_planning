...
motion_planning_path = os.path.abspath(
    os.path.join(package_path, "src/redundant_motion_planning/motion_planning")
)
...
collision_checking_script = os.path.join(package_path, "src/redundant_motion_planning/collision_checking/collision_checking_pybullet.py")
graph_based_optimum_script = os.path.join(motion_planning_path, "graph_based_optimum.py")
editing_script = os.path.join(package_path, "src/redundant_motion_planning/utilities/preprocessing/edit.py")
